...
- ✅ `Order` - Order lifecycle (schema ready)
- ✅ `InventoryReservation` - Stock reservations (schema ready)
- ✅ `Review` - Product reviews (schema ready)
- ✅ `Experiment` - Experiment tracking

**Pending Implementation:**
- ⏳ `outbox` table (for event publishing)
- ⏳ `experiment_assignments` table (for A/B testing)
...
- [ ] Implement cart merge logic (anonymous → user) with deterministic rules
...
### Phase 3: Background Workers ⏳ **PENDING**
...
### Phase 4: Search & Recommendations ⏳ **PENDING**
...
### Phase 5: Observability Enhancement ⏳ **PENDING**
